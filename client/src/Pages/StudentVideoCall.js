...
export default class StudentVideoCall extends React.Component {
    constructor(props)
    {
        ...
        // Set up Peer JS
        this.peer = new Peer(this.props.match.params.peerJsId)
        ...
        this.peer.on('open', function(id) {
            ...
            {
                careerFair: props.match.params.careerFairId,
                recruiterId: props.match.params.recruiterId,
                peerJsId: props.match.params.peerJsId
            });
        });
