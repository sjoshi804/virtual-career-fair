...
export default class OrganizerPastPage extends React.Component {
    handleRoute = route => () => {
  ...
  render() {
    ...
    <CardDeck>
        <Card  border="success" style={{"boxShadow": "0 4px 8px 0 rgba(0,0,0,0.2)"}}>
            ...
            <Card.Text>
                <br></br>
                <b>Recruiters Attended: </b> {Math.floor(Math.random() * Math.floor(5)) + 2}
                <br></br>
                <br></br>
        ...
        <Card  border="danger" style={{"boxShadow": "0 4px 8px 0 rgba(0,0,0,0.2)", "width": "300px"}}>
            ...
            <Card.Text>
            <br></br>
                <b>Students Attended: </b> {Math.floor(Math.random() * Math.floor(5)) + 2}
                <br></br>
                <br></br>
        ...
        <Card  border="dark" style={{"boxShadow": "0 4px 8px 0 rgba(0,0,0,0.2)"}}>
            ...
            <Card.Text>
            <br></br>
                <b>Companies Attended: </b> {Math.floor(Math.random() * Math.floor(5)) + 2}
                <br></br>
                <br></br>
