...
export default class OrganizerLoginPage extends React.Component {
    constructor(props) {
        ...
        this.handleAffiliatedOrganizationChange = this.handleAffiliatedOrganizationChange.bind(this);
    }
        ...
        const response = 
            (await fetch(baseUrl + '/organizer/', {
                ...
                body: JSON.stringify({
                    ...
                    affiliatedOrganization: this.state.affiliatedOrganization
                })
            })
            .then(response => {
    ...
    handleAffiliatedOrganizationChange(e) {
        this.setState({affiliatedOrganization: e.target.value});
    }
                    ...
                    <Card style={{"box-shadow": "8px 4px 8px 4px rgba(0,0,0,0.2)", "padding": "20px", "max-width": "80%", "margin": "auto"}}>
                        <Tabs defaultActiveKey="signin" id="uncontrolled-tab-example" style={{"margin": "auto"}}>
                            ...
                            <Form style={{"padding-top": "10px"}}>
                                ...
                                <Form.Group>
                                    <Form.Label controlId="formAffiliatedOrganization">Affiliated Organization</Form.Label>
                                    <Form.Control type="text" placeholder="E.g. UCLA, CalPoly SLO, UC Berkeley, etc." value={this.state.affiliatedOrganization} onChange={this.handleAffiliatedOrganizationChange}/>
                                </Form.Group>
                                <Form.Group controlId="formBasicPassword">
                                    <Form.Label>Password</Form.Label>
                                    <Form.Control type="password" placeholder="Password" value={this.state.password} onChange={this.handlePasswordChange}/>
