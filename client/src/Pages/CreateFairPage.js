  ...
  render() {
    return (
      <div style={{ "background-color": "white", color: "white", "width": "500px", "margin": "auto", "margin-top": "20vh"}}>
        <Card style={{"padding": "50px", "boxShadow": "0 4px 8px 0 rgba(0,0,0,0.2)"}}>
        <Form>
        <Form.Group controlId="formBasicEmail">
          <Card.Text>
            <Form.Label style={{"color": "black", "textAlign": "left"}}>New Fair Name</Form.Label>
          </Card.Text>
          <Form.Control type="fairname" placeholder="Enter the name of the career fair" />
        </Form.Group>
        <Form.Group controlId="formBasicPassword">
          <Card.Text>
            <Form.Label style={{"color": "black", "textAlign": "left"}}>Fair Time Period</Form.Label>
          </Card.Text>
